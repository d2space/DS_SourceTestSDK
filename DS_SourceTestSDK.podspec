...
#不确定是否这么写
  s.resource_bundles  = {'DS_SourceTestSDK' => ['DS_SourceTestSDK/*.{jpg,png}','DS_SourceTestSDK/*.{storyboard,xib}']}

#尝试
  s.resources = ['DS_SourceTestSDK.framework/*.{jpg,png}','DS_SourceTestSDK.framework/*.{storyboard,xib}']
